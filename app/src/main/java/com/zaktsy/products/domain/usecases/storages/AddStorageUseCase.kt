...
class AddStorageUseCase @Inject constructor(private val repository: ProductsRepository) {
    suspend operator fun invoke(storage: Storage) = repository.addStorage(storage)
}